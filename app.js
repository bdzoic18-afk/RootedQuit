...
el('saveJournal').onclick=()=>{day().journal=el('journalText').value;save();el('journalStatus').textContent='Saved. You showed up for yourself.';setTimeout(()=>el('journalStatus').textContent='Your entry stays on this device.',2600)};
